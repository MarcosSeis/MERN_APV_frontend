...
const Registrar = () => {
  ...
  return (
    <>
        <div>
          <h1 className="text-indigo-600 font-black text-6xl ">Crea tú cuenta y Administra tus <span className="text-black">pacientes</span> </h1>
        </div>
        <div className='mt-20 md:mt-5 shadow-lg px-5 py-10 rounded-xl bg-white'>
            ...
            <div className="my-5">
              ...
              <div className="my-5">
                <label
                  className="uppercase text-gray-500 block text-xl font-bold"
                  htmlFor="">Repite tú Password</label>
                <input 
                  type="password"
